...
## 📢 Important Announcement: TechUI-React-Lite been deprecated

The **TechUI-React-Lite** component library has been deprecated and is now superseded by the brand-new **TechUI-Scifi(Vue)** component library.
...
## 📢 重要通知：TechUI-React-Lite 现已废弃

**TechUI-React-Lite** 组件库现已废弃，已被全新的 **TechUI-Scifi(Vue3)** 组件库所取代。
